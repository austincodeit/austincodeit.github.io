...
if(arrayPos>=list.length){tasklistComplete();return;}else{addressLoop();}};dangerousAddressSearch=function(input){let foundAddress=dangerousDogArray.filter(function(item,idx){if(input.toUpperCase().indexOf(item.ADDRESS)>=0){console.log('found',idx)
