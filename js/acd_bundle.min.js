...
let addAddressFromInput=function(address){$("#routableAddressRows").append('<tr>'+'<td class="first"><span id="count"></span>'+'<button type="button" class="btn btn-sm btn-default removeAddress">'+'<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>'+'</button>----</td>'+'<td class="b">n/a</td>'+'<td class="c">temp: ('+address+')</td>'+'<td class="a">----</td>'+'<td class="a">----</td>'+'<td class="a">----</td>'+'<td class="a">----</td>'+'<td class="c">----</td>'+'<td class="c" id="location">'+address+'</td>'+'</tr>');$activeElement=$("#routableAddressRows > tr:not(.placeholder):last-child").children("td#location");global_func.validateRemoveButton();global_func.adjustRowCount();global_func.placeAddressOnMap(address,address,false);}
...
let $tableRow=$("#availableAddressRows tr").children("td#"+id+"").parent()[0];let newAddress=$($tableRow).children("td#location").text().trim()+", Austin, TX";let popUpText=$($tableRow).children("td#location").text().trim();$activeElement=$($tableRow).children("td#location");$("#routableAddressRows").append('<tr>'+'<td class="first"><span id="count"></span>'+'<button type="button" class="btn btn-sm btn-default removeAddress">'+'<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>'+'</button>'+$($tableRow).children("td:nth-child(1)").text()+'</td>'+'<td class="b">'+$($tableRow).children("td:nth-child(2)").text()+'</td>'+'<td class="b">'+$($tableRow).children("td:nth-child(3)").text()+'</td>'+'<td class="c" id="location">'+$($tableRow).children("td:nth-child(4)").text()+'</td>'+'<td class="a">'+$($tableRow).children("td:nth-child(5)").text()+'</td>'+'<td class="a">'+$($tableRow).children("td:nth-child(6)").text()+'</td>'+'<td class="a">'+$($tableRow).children("td:nth-child(7)").text()+'</td>'+'<td class="a">'+$($tableRow).children("td:nth-child(8)").text()+'</td>'+'<td class="c">'+$($tableRow).children("td:nth-child(9)").text()+'</td>'+'<td class="c">'+$($tableRow).children("td:nth-child(10)").text()+'</td>'+'</tr>');$activeElement=$("#routableAddressRows > tr:not(.placeholder):last-child").children("td#location");global_func.validateRemoveButton();global_func.adjustRowCount();global_func.placeAddressOnMap(newAddress,popUpText,false);infowindow.close();});});taskListMarkerArray.push(newTaskMarker);}
...
let postUrl="https://www.googleapis.com/urlshortener/v1/url?&key="+_selectedYek;let _longUrl=google_url_start+urlWayPoint+"&views=traffic";$.ajax({url:postUrl,type:"POST",dataType:'json',contentType:'application/json; charset=utf-8',data:'{ longUrl: "'+_longUrl+'"}',}).done(function(data){console.log(data)
$("#google_url_input").val(data.id);$("#google_url_link").html("<a href="+data.id+" target='_blank'>Open in Google Maps: "+data.id+"</a>");$("#urlDialog").show();$("#urlDialog").dialog({width:500,close:function(event,ui){$("#urlDialog").hide();$("#google_url_link").html("");}});});}
$("#mobileFunc").on('click',function(){sendMapToMobile();});$("#getGoogleUrl").on('click',function(){openGoogleUrlDialog();});$("#urlDialog").hide();$("#close-url-modal").on('click',function(){console.log('dialog closed')
$("#urlDialog").dialog("close");$("#urlDialog").hide();});$("#copy-url-from-modal").on('click',function(){var copyText=document.getElementById("google_url_input");copyText.select();document.execCommand("Copy");$("span#routeToolTip.tooltiptext").html("Copied: "+copyText.value);});$("#copy-url-from-modal").mouseout(function(){$("span#routeToolTip.tooltiptext").html("Copy to Clipboard");});});