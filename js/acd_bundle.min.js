...
$("#urlDialog").dialog("close");$("#urlDialog").hide();});$("#copy-url-from-modal").on('click',function(){var copyText=document.getElementById("google_url_input");console.log(copyText);copyText.select();document.execCommand("Copy");alert("Copied the text: "+copyText.value);});});